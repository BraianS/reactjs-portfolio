        ...
        <div className='w-full h-screen bg-container flex flex-col justify-between hero' id="hero">
            <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
                <div className="flex flex-col justify-center pb-5 sm:pb-5 md:pb-5 items-center md:items-start w-full px-2">
                    <p className='text-2xl subtitle'>Analista de sistemas</p>
                    <h1 className='py-3 text-5xl md:text-7xl font-bold title'>Olá!Meu nome é Braian Silva</h1>
                    <a href="#portfolio" className='py-3 hero__button  flex justify-center text-2xl w-[60%] rounded-full font-semibold'>Explore
                ...
                <div className="flex justify-center md:justify-start">
                    <img className=' h-[300px] hero__image rounded-full' src={profile} alt="profile" />
                </div>
            </div>
        </div>
    )
